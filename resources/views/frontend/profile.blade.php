...
<div class="col-lg-9">
	...
	<div class="row">
		...
		<div class="col-lg-6 my-4" style="font-size:25px;">
			Name:<strong >Aye Mya Mya Aung</strong><br>
			Email:<strong>aye62442@gmail.com</strong><br>
			Address:<strong>Sagiang</strong><br>
		...
		<div class="col-lg-12">
			...
			<div class="form-group">
				Name:<input type="text" name="name" value="" placeholder="If you change your name,you can change here!" class="form-control" style="border-radius: 20px;height: 50px;">
			</div>
			<div class="form-group">
				Email:<input type="text" name="name" value="" placeholder="If you change your email,you can change here!" class="form-control" style="border-radius: 20px;height: 50px;">
			</div>
			<div class="form-group">
