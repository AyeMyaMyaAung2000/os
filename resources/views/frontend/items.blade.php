...
@section('content')
<div class="col-lg-9">
	<h2 class="my-4" style="text-align: center;">Item Page Filter By brand and subcategory</h2>
		...
		function showItems(id){
			$.post("{{route('getitems')}}",{sid:id},function(res){
				...
				$.each(res,function(i,v){
					...
					<a href="" class="addtocart btn btn-info" data-id="${v.id}" data-name="${v.name}" data-photo="${v.photo}" data-price="${v.price}" data-discount="${v.discount}">Add to Cart</a>
